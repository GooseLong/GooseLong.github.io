...
{
	if (region.aP.ah === region.a0.ah)
	{
		return 'on line ' + region.aP.ah;
	}
	return 'on lines ' + region.aP.ah + ' through ' + region.a0.ah;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cL, request.dA, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a3: fragment, a9: host, bm: path, bo: port_, br: protocol, bs: query};
	});
...
var $author$project$Story$Loading = {$: 0};
var $author$project$Main$StoryMsg = function (a) {
	return {$: 1, a: a};
};
var $author$project$Story$StoryletID = $elm$core$Basics$identity;
...
var $mdgriffith$elm_ui$Element$classifyDevice = function (window) {
	return {
		a_: function () {
			var shortSide = A2($elm$core$Basics$min, window.bJ, window.a6);
			var longSide = A2($elm$core$Basics$max, window.bJ, window.a6);
			return (shortSide < 600) ? 0 : ((longSide <= 1200) ? 1 : (((longSide > 1200) && (longSide <= 1920)) ? 2 : 3));
		}(),
		_: (_Utils_cmp(window.bJ, window.a6) < 0) ? 0 : 1
	};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bZ: false, b5: r.b5, cq: r.cq, a5: r.a5, cL: r.cL, du: r.du, bE: r.bE, dA: r.dA}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{b5: $elm$http$Http$emptyBody, cq: r.cq, a5: _List_Nil, cL: 'GET', du: $elm$core$Maybe$Nothing, bE: $elm$core$Maybe$Nothing, dA: r.dA});
};
var $author$project$Story$ErrorLoadingStory = function (a) {
	return {$: 1, a: a};
};
var $author$project$Story$LoadedStory = function (a) {
	return {$: 0, a: a};
};
var $author$project$Story$gotStory = function (result) {
	if (!result.$) {
		var storylets = result.a;
		return $author$project$Story$LoadedStory(storylets);
	} else {
		var error = result.a;
...
var $author$project$Story$Storylet = F4(
	function (id, character, paragraph, options) {
		return {cf: character, ag: id, bj: options, bl: paragraph};
	});
var $author$project$Story$Athol = 1;
var $author$project$Story$Chippy = 0;
var $author$project$Story$Clawdious = 2;
var $author$project$Story$End = 4;
var $author$project$Story$Rowan = 3;
...
var $author$project$Story$optionsDecoder = $elm$json$Json$Decode$keyValuePairs(
	A2($elm$json$Json$Decode$map, $elm$core$Basics$identity, $elm$json$Json$Decode$int));
var $author$project$Story$storyletDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Story$Storylet,
	A2(
		$elm$json$Json$Decode$field,
		'id',
		A2($elm$json$Json$Decode$map, $elm$core$Basics$identity, $elm$json$Json$Decode$int)),
	A2($elm$json$Json$Decode$field, 'character', $author$project$Story$characterDecoder),
	A2($elm$json$Json$Decode$field, 'paragraph', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'options', $author$project$Story$optionsDecoder));
var $author$project$Story$storyDecoder = A2(
	$elm$json$Json$Decode$field,
	'story',
...
var $author$project$Main$init = function (windowSize) {
	return _Utils_Tuple2(
		{
			L: 1,
			_: $mdgriffith$elm_ui$Element$classifyDevice(windowSize)._,
			T: $author$project$Story$Loading
		},
		A2(
			...
			$elm$http$Http$get(
				{
					cq: A2($elm$http$Http$expectJson, $author$project$Story$gotStory, $author$project$Story$storyDecoder),
					dA: 'assets/story.json'
				})));
};
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$browser$Browser$Events$onResize(
		F2(
			function (w, h) {
				return A2($author$project$Main$WindowResized, w, h);
			}));
};
var $author$project$Story$Error = function (a) {
	return {$: 2, a: a};
};
				...
				var mbStorylets = A3(
					...
					$elm$core$List$head(
						A2(
							$elm$core$List$filter,
							function (strlt) {
								return _Utils_eq(strlt.ag, oldId);
							},
							storylets)),
					$elm$core$List$head(
						A2(
							$elm$core$List$filter,
							function (strlt) {
								return _Utils_eq(strlt.ag, newId);
							},
							storylets)));
				if (!mbStorylets.$) {
					...
					return (!_Utils_eq(oldStorylet.cf, newStorylet.cf)) ? $elm$core$Maybe$Just(
						$author$project$Story$characterToString(newStorylet.cf)) : $elm$core$Maybe$Nothing;
				} else {
					return $elm$core$Maybe$Nothing;
				}
		}
		...
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						_: $mdgriffith$elm_ui$Element$classifyDevice(
							{a6: h, bJ: w})._
					}),
			...
			switch (storyMsg.$) {
				case 0:
					...
					var _v2 = A2($author$project$Story$getStoryletFromId, model.L, storylets);
					if (_v2.$ === 1) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									T: $author$project$Story$Error(
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									T: $author$project$Story$Loaded(storylets)
								}),
							$author$project$Main$audioControl(
								$author$project$Story$characterToString(storylet.cf)));
					}
				case 1:
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								T: $author$project$Story$Error(error)
							}),
						$elm$core$Platform$Cmd$none);
				default:
					var storyletid = storyMsg.a;
					var _v3 = A3($author$project$Story$newCharacter, model.L, storyletid, model.T);
					if (!_v3.$) {
...
var $mdgriffith$elm_ui$Internal$Style$classes = {bP: 'a', az: 'atv', bR: 'ab', bS: 'cx', bT: 'cy', bU: 'acb', bV: 'accx', bW: 'accy', bX: 'acr', aV: 'al', aW: 'ar', bY: 'at', aA: 'ah', aB: 'av', b$: 's', b3: 'bh', b4: 'b', b6: 'w7', b8: 'bd', b9: 'bdt', ao: 'bn', ca: 'bs', ap: 'cpe', cg: 'cp', ch: 'cpx', ci: 'cpy', D: 'c', ar: 'ctr', as: 'cb', at: 'ccx', E: 'ccy', ae: 'cl', au: 'cr', ck: 'ct', cl: 'cptr', cm: 'ctxt', ct: 'fcs', a2: 'focus-within', cu: 'fs', cv: 'g', aF: 'hbh', aG: 'hc', a7: 'he', aH: 'hf', a8: 'hfp', cx: 'hv', cz: 'ic', cB: 'fr', aw: 'lbl', cD: 'iml', cE: 'imlf', cF: 'imlp', cG: 'implw', cH: 'it', cI: 'i', be: 'lnk', Z: 'nb', bh: 'notxt', cO: 'ol', cQ: 'or', Q: 'oq', cU: 'oh', bk: 'pg', bl: 'p', cV: 'ppe', cY: 'ui', u: 'r', c_: 'sb', c$: 'sbx', c0: 'sby', c1: 'sbt', c4: 'e', c5: 'cap', c6: 'sev', dd: 'sk', p: 't', dg: 'tc', dh: 'w8', di: 'w2', dj: 'w9', dk: 'tj', ay: 'tja', dl: 'tl', dm: 'w3', dn: 'w5', $7: 'w4', dp: 'tr', dq: 'w6', dr: 'w1', ds: 'tun', bF: 'ts', U: 'clr', dy: 'u', aR: 'wc', bK: 'we', aS: 'wf', bL: 'wfp', aT: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.b$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.D);
...
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.b$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bk);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.b$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bl);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.b$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.u);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.b$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c4);
...
var $mdgriffith$elm_ui$Internal$Model$getStyleName = function (style) {
	switch (style.$) {
		...
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.u) + ('-' + ($elm$core$String$fromInt(pos.cj) + ('-' + ($elm$core$String$fromInt(pos.bJ) + ('-' + $elm$core$String$fromInt(pos.a6)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cx, $mdgriffith$elm_ui$Internal$Style$classes.U)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b$) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.u) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b$) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b$) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.u) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b$) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ar) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aq: closing, i: _List_Nil, H: _List_Nil, v: selector};
	});
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.v + ('{' + (renderValues(rule.H) + (rule.aq + '}')));
		}
	};
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 9:
				...
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.u) + ('-' + ($elm$core$String$fromInt(position.cj) + ('-' + ($elm$core$String$fromInt(position.bJ) + ('-' + $elm$core$String$fromInt(position.a6)))))));
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {a6: height / size, bA: size, bH: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cd, adjustment.b2, adjustment.cn, adjustment.cK]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.b$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c4))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b$, $mdgriffith$elm_ui$Internal$Style$classes.c4, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.E, $mdgriffith$elm_ui$Internal$Style$classes.bX])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b$, $mdgriffith$elm_ui$Internal$Style$classes.c4, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.E, $mdgriffith$elm_ui$Internal$Style$classes.bV])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b$, $mdgriffith$elm_ui$Internal$Style$classes.c4, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.bW])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b$, $mdgriffith$elm_ui$Internal$Style$classes.c4, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.bU])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.b$ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.p + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aR + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aG)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.b$ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.p + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aH)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.c4, $mdgriffith$elm_ui$Internal$Style$classes.bP]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.c4, $mdgriffith$elm_ui$Internal$Style$classes.b4]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.c4, $mdgriffith$elm_ui$Internal$Style$classes.cQ]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.c4, $mdgriffith$elm_ui$Internal$Style$classes.cO]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.c4, $mdgriffith$elm_ui$Internal$Style$classes.cB]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.c4, $mdgriffith$elm_ui$Internal$Style$classes.b3]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aA + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aV);
		case 2:
...
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		...
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bT);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.b$ + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.D + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.b$ + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.u + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{ct: $elm$core$Maybe$Nothing, cx: $elm$core$Maybe$Nothing, cM: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.cY, $mdgriffith$elm_ui$Internal$Style$classes.b$, $mdgriffith$elm_ui$Internal$Style$classes.c4]))),
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.at + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.E + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.c1 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bh)))))),
						A2(
							$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ck + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ae)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
		...
		switch (story.$) {
			...
			case 2:
				...
				return $mdgriffith$elm_ui$Element$text(
					$author$project$Story$errorToString(error));
			default:
				var storylets = story.a;
								...
								[
												...
												return A2(
													...
													_Utils_Tuple2(
														...
														A2(
															...
															{af: 'Chiptune', ai: 'assets/chippy_min.png'})));
											case 1:
												return A2(
													$mdgriffith$elm_ui$Element$Keyed$el,
													_List_fromArray(
													...
													_Utils_Tuple2(
														...
														A2(
															...
															{af: 'Athol', ai: 'assets/athol_min.jfif'})));
											case 2:
												return A2(
													$mdgriffith$elm_ui$Element$Keyed$el,
													_List_fromArray(
													...
													_Utils_Tuple2(
														...
														A2(
															...
															{af: 'Clawdious', ai: 'assets/clawdious_min.jfif'})));
											case 3:
												return A2(
													$mdgriffith$elm_ui$Element$Keyed$el,
													_List_fromArray(
													...
													_Utils_Tuple2(
														...
														A2(
															...
															{af: 'Rowan', ai: 'assets/rowan_min.png'})));
											default:
												return A2(
													$mdgriffith$elm_ui$Element$Keyed$el,
													_List_fromArray(
													...
													_Utils_Tuple2(
														...
														A2(
															...
															{af: 'End_error', ai: 'assets/error.png'})));
										}
									}()),
									A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$mdgriffith$elm_ui$Element$text(storylet.bl)
												])),
											A2(
											$mdgriffith$elm_ui$Element$column,
											_List_fromArray(
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		A2(
			...
			$author$project$Main$StoryMsg,
			A3($author$project$Story$viewStorylet, model.L, model._, model.T)));
};
