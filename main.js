...
{
	if (region.aP.ag === region.a$.ag)
	{
		return 'on line ' + region.aP.ag;
	}
	return 'on lines ' + region.aP.ag + ' through ' + region.a$.ag;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cJ, request.dA, true);
		} catch (e) {
		...
		request.b1.a && xhr.setRequestHeader('Content-Type', request.b1.a);
		xhr.send(request.b1.b);
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a2: fragment, a8: host, bk: path, bm: port_, bp: protocol, bq: query};
	});
...
var $mdgriffith$elm_ui$Element$classifyDevice = function (window) {
	return {
		aZ: function () {
			var shortSide = A2($elm$core$Basics$min, window.bF, window.a5);
			var longSide = A2($elm$core$Basics$max, window.bF, window.a5);
			return (shortSide < 600) ? 0 : ((longSide <= 1200) ? 1 : (((longSide > 1200) && (longSide <= 1920)) ? 2 : 3));
		}(),
		_: (_Utils_cmp(window.bF, window.a5) < 0) ? 0 : 1
	};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bV: false, b1: r.b1, cn: r.cn, a4: r.a4, cJ: r.cJ, dt: r.dt, bA: r.bA, dA: r.dA}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{b1: $elm$http$Http$emptyBody, cn: r.cn, a4: _List_Nil, cJ: 'GET', dt: $elm$core$Maybe$Nothing, bA: $elm$core$Maybe$Nothing, dA: r.dA});
};
...
var $author$project$Story$Storylet = F4(
	function (id, character, paragraph, options) {
		return {cc: character, af: id, bh: options, bj: paragraph};
	});
...
var $author$project$Main$init = function (windowSize) {
	return _Utils_Tuple2(
		...
		A2(
			...
			$elm$http$Http$get(
				{
					cn: A2($elm$http$Http$expectJson, $author$project$Story$gotStory, $author$project$Story$storyDecoder),
				...
				var mbStorylets = A3(
					...
					$elm$core$List$head(
						A2(
							$elm$core$List$filter,
							function (strlt) {
								return _Utils_eq(strlt.af, oldId);
							},
							storylets)),
					$elm$core$List$head(
						A2(
							$elm$core$List$filter,
							function (strlt) {
								return _Utils_eq(strlt.af, newId);
							},
							storylets)));
				if (!mbStorylets.$) {
					...
					return (!_Utils_eq(oldStorylet.cc, newStorylet.cc)) ? $elm$core$Maybe$Just(
						$author$project$Story$characterToString(newStorylet.cc)) : $elm$core$Maybe$Nothing;
				} else {
					return $elm$core$Maybe$Nothing;
				}
		}
					...
					if (_v2.$ === 1) {
						...
						return _Utils_Tuple2(
							...
							$author$project$Main$audioControl(
								$author$project$Story$characterToString(storylet.cc)));
					}
				case 1:
...
var $mdgriffith$elm_ui$Internal$Style$classes = {bL: 'a', ax: 'atv', bN: 'ab', bO: 'cx', bP: 'cy', bQ: 'acb', bR: 'accx', bS: 'accy', bT: 'acr', aV: 'al', aW: 'ar', bU: 'at', ay: 'ah', az: 'av', bX: 's', b$: 'bh', b0: 'b', b2: 'w7', b4: 'bd', b5: 'bdt', am: 'bn', b6: 'bs', an: 'cpe', cd: 'cp', ce: 'cpx', cf: 'cpy', D: 'c', ap: 'ctr', aq: 'cb', ar: 'ccx', E: 'ccy', ae: 'cl', as: 'cr', ch: 'ct', ci: 'cptr', cj: 'ctxt', cq: 'fcs', a1: 'focus-within', cr: 'fs', cs: 'g', aE: 'hbh', aF: 'hc', a6: 'he', aG: 'hf', a7: 'hfp', cu: 'hv', cw: 'ic', cy: 'fr', au: 'lbl', cA: 'iml', cB: 'imlf', cC: 'imlp', cD: 'implw', cE: 'it', cF: 'i', bc: 'lnk', Z: 'nb', bf: 'notxt', cM: 'ol', cO: 'or', Q: 'oq', cS: 'oh', bi: 'pg', bj: 'p', cT: 'ppe', cX: 'ui', u: 'r', cZ: 'sb', c_: 'sbx', c$: 'sby', c0: 'sbt', c3: 'e', c4: 'cap', c5: 'sev', dc: 'sk', p: 't', df: 'tc', dg: 'w8', dh: 'w2', di: 'w9', dj: 'tj', aw: 'tja', dk: 'tl', dl: 'w3', dm: 'w5', dn: 'w4', $7: 'tr', dp: 'w6', dq: 'w1', dr: 'tun', bB: 'ts', U: 'clr', dy: 'u', aR: 'wc', bG: 'we', aS: 'wf', bH: 'wfp', aT: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cs);
...
var $mdgriffith$elm_ui$Internal$Model$getStyleName = function (style) {
	switch (style.$) {
		...
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.u) + ('-' + ($elm$core$String$fromInt(pos.cg) + ('-' + ($elm$core$String$fromInt(pos.bF) + ('-' + $elm$core$String$fromInt(pos.a5)))))));
		case 11:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							...
							'grid-column: ' + ($elm$core$String$fromInt(position.cg) + (' / ' + ($elm$core$String$fromInt(position.cg + position.bF) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.u) + ('-' + ($elm$core$String$fromInt(position.cg) + ('-' + ($elm$core$String$fromInt(position.bF) + ('-' + $elm$core$String$fromInt(position.a5)))))));
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {a5: height / size, bx: size, bD: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.ca, adjustment.b_, adjustment.ck, adjustment.cI]);
	var lineHeight = 1.5;
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bX, $mdgriffith$elm_ui$Internal$Style$classes.c3, $mdgriffith$elm_ui$Internal$Style$classes.ap, $mdgriffith$elm_ui$Internal$Style$classes.E, $mdgriffith$elm_ui$Internal$Style$classes.bT])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bX, $mdgriffith$elm_ui$Internal$Style$classes.c3, $mdgriffith$elm_ui$Internal$Style$classes.ap, $mdgriffith$elm_ui$Internal$Style$classes.E, $mdgriffith$elm_ui$Internal$Style$classes.bR])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bX, $mdgriffith$elm_ui$Internal$Style$classes.c3, $mdgriffith$elm_ui$Internal$Style$classes.ap, $mdgriffith$elm_ui$Internal$Style$classes.bS])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bX, $mdgriffith$elm_ui$Internal$Style$classes.c3, $mdgriffith$elm_ui$Internal$Style$classes.ap, $mdgriffith$elm_ui$Internal$Style$classes.bQ])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.p + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aR + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aF)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.p + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aG)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.c3, $mdgriffith$elm_ui$Internal$Style$classes.bL]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
							...
							case 4:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.c3, $mdgriffith$elm_ui$Internal$Style$classes.cy]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.ay + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aV);
		case 2:
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ar + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.E + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.c0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bf)))))),
						A2(
							$elm$core$List$cons,
							...
							[
								...
								A2(
									...
									function () {
										...
										switch (_v4) {
											case 0:
												return {aC: 'Chiptune', aO: 'assets/chippy.png'};
											case 1:
												return {aC: 'Athol', aO: 'assets/error.png'};
											default:
												return {aC: 'Clawdious', aO: 'assets/error.png'};
										}
									}())),
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text(storylet.bj)
											])),
										A2(
										$mdgriffith$elm_ui$Element$column,
										_List_fromArray(
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{cz: $author$project$Main$init, de: $author$project$Main$subscriptions, dz: $author$project$Main$update, dB: $author$project$Main$view});
